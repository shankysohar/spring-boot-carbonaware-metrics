...
public class CarbonAwareAutoConfiguration {
    ...
    private static final Logger log = LoggerFactory.getLogger(CarbonAwareAutoConfiguration.class);
    ...
    public CarbonAwareSdkClient carbonAwareSdkClient(RestTemplate carbonAwareRestTemplate, CarbonAwareProperties props, CarbonEmissionsParams params) {
        log.info("carbonAwareSdkClient :: "+carbonAwareRestTemplate);
        log.info("CarbonAwareProperties :: "+props);
        log.info("CarbonEmissionsParams :: "+params);
